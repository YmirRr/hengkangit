  ...
  export default({
    ...
    methods:{
      ...
      InitTable(index,row){//二维表
        ...
        // 商品规格（尺码，数量,颜色）
        self.$axios.gets("/api/services/app/SkuManagement/GetSKUList",
          {
      ...
      loadData:function(){
        ...
        if(self.$route.params.id!='default'){
          ...
          //根据id获得的信息
          this.$axios.gets(self.url+'/api/services/app/OmsRtoManagement/GetDetailsById',
            ...
            // 退货仓库下拉
            self.$axios.gets("/api/services/app/StockManagement/GetRepositoryList",
              {
                defaultOuId:'',
                StockCode:'',
                StockName:'',
            ...
            // 物流公司下拉
            self.$axios.gets("/api/services/app/ContactManagement/GetListByConditionSupplier",
              {
      ...
      saveCustomerModify:function(){//修改所有
        ...
        self.$validate().then(function(success){
          if(success){
            ...
            self.$axios.puts(self.url+'/api/services/app/OmsRtoManagement/UpdateOmsWebrto',submitData).then(function(res){
      ...
      changeGoods(){
        ...
        self.$axios.gets(self.url+'/api/services/app/OmsRtoManagement/GetWebrtoDtlExchange',
          {
      ...
      sureReturnGoods(){//确定换货
        ...
        if(self.exchangeData.length>0){
          ...
          self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/JumpToExchange',
            {
              jumpWebrtoDto:{
                billCode:self.topDetailInfo.billCode,//销售订单号
                groupId:self.topDetailInfo.groupId,//集团id
      ...
      hangUp(){//挂起操作
        ...
        self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/SuspendRto', self.hangUpArr).then(function(res){//
      ...
      relieveSuspendRto(){//解挂
        ...
        self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/RelieveSuspendRto', ids).then(function(res){//
      ...
      checkOrder(){//审核
        ...
        console.log();
        self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/Check',{id:checkId}).then(function(res){//
      ...
      insteadCheck(){//反审核
        ...
        let checkId=parseInt(self.$route.params.id);
        console.log(checkId);
        self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/InsteadCheck',{id:checkId}).then(function(res){
      ...
      delSupplie:function(){//删除此页退货单页面
        ...
        self.$axios.deletes(self.url+'/api/services/app/OmsRtoManagement/DeleteOmsWebrto', {id:deteleId}).then(function(res){//
      ...
      dialogClick(parmas){//对话框点击
        ...
        if(parmas.dialogButton=="确定"){
          if(parmas.dialogName=="delDialog"){//删除对话框
            self.$axios.deletes(self.url+'/api/services/app/OMSWebrtoMangement/DeleteOmsWebrto',{id:self.$route.params.id}).then(function(res){
              self.open('删除成功','el-icon-circle-check','successERP');
              self.back();
            },function(res){
              // self.dialogVisible=true;
