    ...
    methods:{
      ...
      loadData:function(){
        ...
        if (self.$route.params.id != "default") {
            ...
            //根据id获得的详情信息
          this.$axios.gets(self.url+'/api/services/app/OmsSoManagement/GetWebsoMtrDataById',
      ...
      loadSelect:function(){
        let self = this;
        // 店铺下拉数据
        self.$axios.gets(self.url+"/api/services/app/OmsWebShopManagement/GetAll", {
          SkipCount:0,
          MaxResultCount:999
        }).then(function(res) {
          // 店铺
        ...
        self.$axios.gets("/api/services/app/DataDictionary/GetDictItem", {dictName: "OMS_Distributionmode"
        }).then(function(res) {
          // 物流方式
        ...
        //发货店铺
        self.$axios.gets("/api/services/app/ShopManagement/GetAll",
          {
            ShopTypeid:'',
            OuId:'',
            AdAreaId:'',
      ...
      saveCustomerModify:function(){//修改所有
        ...
        self.$validate().then(function(success) {
          ...
          if (success) {
            ...
            console.log(submit);
            self.$axios.puts(self.url + '/api/services/app/OmsSoManagement/UpdateOmsWebsoMtr', submit).then(function (res) {
              console.log(res);
      ...
      changeGoods(){
        let self=this;
        self.$axios.gets(self.url+'/api/services/app/OmsRtoManagement/GetWebsoDtlDataByCode',
          {
      ...
      sureReturnGoods(){//确定退货
        ...
        if(self.exchangeData.length>0){
          ...
          self.$axios.posts(self.url+'/api/services/app/OmsRtoManagement/JumpToOmsWebrto',
            {
              jumpWebrtoDto:{
                billCode:self.topDetailInfo.billCode,//销售订单号
                groupId:self.topDetailInfo.groupId,//集团id
      ...
      hangUp(){//挂起
          ...
          self.$axios.posts(self.url+'/api/services/app/OmsSoManagement/SuspendWebsoMtr',
            self.hangUpArr
          ).then(function(res){//
      ...
      SolutionToHang(){//解挂
        ...
        self.$axios.posts(self.url+'/api/services/app/OmsSoManagement/RelieveSuspendWebsoMtr',
          self.solutionId
        ).then(function(res){//
...
//----------------------------------------------------
      ...
      againstCheckOrder(){//反审核
        let self=this;
        self.$axios.posts(self.url+"/api/services/app/OmsSoManagement/InsteadCheck",
          {id:self.$route.params.id}
          ).then(function(res) {
      ...
      dialogClick(parmas){//对话框点击事件
        ...
        if(parmas.dialogButton=="确定"){
          if(parmas.dialogName=="delDialog"){//删除对话框
            self.$axios.deletes(self.url+'/api/services/app/OmsSoManagement/DeleteOmsWebsoMtr',{id:self.$route.params.id}).then(function(res){
