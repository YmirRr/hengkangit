  ...
  export default {
    data() {
      return {
        ...
        httpUrl:{
          ...
          query:'http://192.168.100.107:8099/api/services/app/OmsRfoManagement/GetSearchData',//条件查询
        },
        queryParams:{//查询条件参数
          WebshopId:'', //网店ID
          RefundTypeId:'', //退款类型ID
    ...
    methods: {
      ...
      getSelectData() {
        ...
        //类型
        _this.$axios.gets("/api/services/app/DataDictionary/GetDictItem", {dictName: "OMS_RefundType"
        }).then(function(res) {
          _this.selectData.RefundTypeId = res.result;
          console.log(_this.selectData.RefundTypeId);
        });
      // 退款状态
        _this.$axios.gets("/api/services/app/DataDictionary/GetDictItem", {dictName: "OMS_RefundStatus"
        }).then(function(res) {
