    ...
    <el-row class="bg-white">
      ...
      <el-col class="left-box" v-show="ifWidth">
        ...
        <el-row class="mt10">
          ...
          <el-col :span="15">
            <el-input class="input-entry" v-model="createLogisticsParams.tacticCode"></el-input>
          </el-col>
        </el-row>
        <!-- 名称 -->
        <el-row class="mt10">
          ...
          <el-col :span="15">
            <el-input class="input-entry" v-model="createLogisticsParams.tacticName"></el-input>
          </el-col>
        </el-row>
        <!-- 状态 -->
        <el-row class="mt10">
          ...
          <el-col :span="15">
            <el-select clearable filterable   v-model="createLogisticsParams.status" placeholder="" class="input-entry">
        ...
        <el-row class="mt10">
          ...
          <el-col :span="15">
            <el-input class="input-entry" v-model="createLogisticsParams.Remark"></el-input>
          </el-col>
        </el-row>
        <!-- 查询按钮 -->
        <el-row class="mt20">
...
//--------------确认删除开始-----------------
                ...
                Name:'',//右上角模糊查询
                tableModel:"logisticsStrategyList",
                dialogVisible:false,
                dialogSetting:{
                    message:'',//提示信息
                    dialogName:'',//对话框名称
                ...
                httpUrl:{
                    view:'/logisticsStrategy/logisticsStrategyModify/',//查看详情
                    delete:'http://192.168.100.107:8099/api/services/app/OmsLogisticsTacticManagement/DeleteTacticById',// 单条删除
                    query:'http://192.168.100.107:8099/api/services/app/OmsLogisticsTacticManagement/GetAll',//条件查询
                },
        ...
        methods:{
            ...
            SimpleSearchClick() {//输入条件查询
                 let _this = this;
                 _this.$axios.gets('http://192.168.100.107:8099/api/services/app/OmsLogisticsTacticManagement/GetSearchData',_this.createLogisticsParams).then(function(res){//查询表格数据
                   _this.$store.commit('setQueryParams',_this.createLogisticsParams);
            ...
            dialogClick(parmas){//对话框按钮点击事件
                ...
                if(parmas.dialogButton=="确定"){
                       ...
                       // console.log(delArray);
                        //批量删除
                        _this.$axios.posts('http://192.168.100.107:8099/api/services/app/OmsLogisticsTacticManagement/BatchDeleteTacticByIdArr',
                        {Ids:delArray}).then(function(res){
