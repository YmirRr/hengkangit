...
//--------------确认删除开始-----------------
        ...
        treeParams:{
          ...
          treeApi:config.base.ip+':'+config.base.basicPort+'/api/services/app/ModuleManagement/GetModulesTree?id=0'//接口地址
        },
    ...
    methods:{
      loadSelectData(){
        ...
        //交易状态
        _this.$axios.gets(_this.url+"/api/services/app/DataDictionary/GetDictItem", {dictName: "OMS_TransStatus"
        }).then(function(res) {
        ...
        //标签
        _this.$axios.gets(_this.url+"/api/services/app/DataDictionary/GetDictItem", {dictName: "OMS_SOTag"
        }).then(function(res) {
          console.log(res.result);
        ...
        //列表数据
        _this.$axios.gets(_this.url2+"/api/services/app/OmsSoManagement/GetWebsoMtrData",_this.queryParams).then(function(res) {
          _this.loading=false;
        ...
        // 业务组织
        //所属组织
        _this.$axios.gets(_this.url+'/api/services/app/OuManagement/GetOuParentList').then(function(res){
          console.log(res);
          _this.ouSelectAr = res.result;
        });
        _this.$axios.gets(_this.url+'/api/services/app/OuManagement/GetAllTree').then(function(res){
          // console.log(res);
          _this.ouAr = res;
      ...
      rowClick(row, event, column) {
        ...
        //查询列表中某一条的详情
        _this.$axios.gets(_this.url2+"/api/services/app/OmsSoManagement/GetWebsoMtrDataById",
          {
            id:row.id
          }).then(function(res){
      ...
      checkOrder(){//审核
        ...
        if(_this.multipleSelection1.length==0){
          ...
          _this.$axios.posts(_this.url2+"/api/services/app/OmsSoManagement/Check", {id:_this.checkId}
          ).then(function(res) {
      ...
      againstCheckOrder(){//反审核
        ...
        if(_this.multipleSelection1.length==0){
          ...
          _this.$axios.posts(_this.url2+"/api/services/app/OmsSoManagement/InsteadCheck", {id:_this.againstCheckId}
          ).then(function(res) {
      ...
      btnClick2:function(data){
        if(data=="挂起"){
          ...
          if(_this.hangUpArr.length==0){
            ...
            _this.$axios.posts(_this.url2+'/api/services/app/OmsSoManagement/SuspendWebsoMtr',
               _this.hangUpArr
            ).then(function(res){//
          ...
          if(_this.hangUpArr.length==0){
            ...
            _this.$axios.posts(_this.url2+'/api/services/app/OmsSoManagement/RelieveSuspendWebsoMtr',
              _this.hangUpArr
            ).then(function(res){//
          ...
          if(_this.hangUpArr.length==0){
            ...
            _this.$axios.posts(_this.url2 + '/api/services/app/OmsSoManagement/WebsoMtrMerge',
              _this.hangUpArr
            ).then(function (res) {//
      ...
      splitOrder(){//拆分订单确定按钮
        ...
        console.log(_this.saleOrderDetail1);
        _this.$axios.posts(_this.url2 + '/api/services/app/OmsSoManagement/WebsoMtrSplit',
          {
            soId:_this.splitId,
      ...
      modifyLogisticsidSure(){//修改物流公司确定按钮
        ...
        _this.$axios.puts(_this.url2+'/api/services/app/OmsSoManagement/UpdateStockId',
          {
      ...
      query(){//条件查询
        let _this=this;
        _this.$axios.gets(_this.url+'/api/services/app/ModuleManagement/GetListByCondition',_this.queryParams).then(function(res){//查询表格数据
        ...
        if(!_this.creatRange){
          if(!_this.effectiveRange){
            if(!_this.dateRange){
              ...
              _this.$axios.gets(_this.url2+'/api/services/app/OmsSoManagement/GetWebsoMtrData',
      ...
      ouNodeClick:function(data,node,self){
        ...
        // 点击所属组织，业务地区跟着变动
        _this.$axios.gets(_this.url+'/api/services/app/OpAreaManagement/GetTreeByOuId',{OuId:data.id}).then(function(res){
          console.log(res);
        },function(res){
          console.log('err'+res)
        });
        // 点击所属组织，对应仓库跟着变动
        _this.$axios.gets(_this.url+'/api/services/app/StockManagement/GetRepositoryList',{OuId:data.id,Start:0,Length:100}).then(function(res){
      ...
      loadTree(){
        ...
        _this.$axios.gets(_this.url+'/api/services/app/ModuleManagement/GetModulesTree',{id:0})
          .then(function(res){
      ...
      TreeNodeClick(data){//树节点点击回调
        ...
        _this.$axios.gets(_this.url+'/api/services/app/ModuleManagement/GetListByCondition',_this.queryParams).then(function(res){
          _this.$store.commit('setQueryParams',_this.queryParams);
          _this.$store.commit('Init_Table',res.result.items);
          let totalPage=Math.ceil(res.result.totalCount/_this.$store.state.menuListEachPage);
          _this.$store.commit('Init_pagination',totalPage);
      ...
      dialogClick(parmas){//对话框按钮点击事件   就是这个按钮是确定时走的
        ...
        if(parmas.dialogButton=="确定"){
          if(parmas.dialogName=="delDialog"){
              ...
              _this.$axios.deletes(_this.url2+'/api/services/app/OmsSoManagement/DeleteOmsWebsoMtr',{id:_this.singleDeleteId}).then(function(res){//查询表格数据
            ...
            _this.$axios.posts(_this.url2+"/api/services/app/OmsSoManagement/BatchDeleteOmsSo", {id:_this.this.hangUpArr}
            ).then(function(res) {
              _this.open('删除成功！','el-icon-circle-check','successERP');
            },function(res){
              _this.dialogVisible = true;
