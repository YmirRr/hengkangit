            ...
            <el-col class="mt10 mb10">
                ...
                <el-row class="bt1">
                    <div class="bgcolor bgradio">
                        ...
                        <el-radio v-model="levelRadio" label="1">单笔满X赠送</el-radio>
                    </div>
                </el-row>
                ...
                <el-row>
                    <div class="bgcolor bgradio">
                        <label>&nbsp;</label>
                        <el-radio v-model="levelRadio" label="2">单笔每满X赠送</el-radio>
                    </div>
                </el-row>
                ...
                <el-row>
                    <div class="bgcolor bgradio">
                        <label>&nbsp;</label>
                        <el-radio v-model="levelRadio" label="3">累计消费X元或Y次赠送</el-radio>
                    </div>
                </el-row>
...
<style scoped>
.consume-detail .erp_bt{
    height:24px;
}
.consume-detail .erp_bt .btDetail{
    line-height:24px;
}
.consume-detail .erp_bt .btImg img{
    top:-4px;
}
.consume-detail .erp_bt{
    padding:0 6px;
...
.consume-detail .sizeNameWrapper{
    margin-top: 5px;
    margin-bottom: 5px;
    display: block;
    width: 59px;
...
.consume-detail .sizeNameWrapper:hover .delSize{
    display: block;
}
.consume-detail .sizeNameWrapper .delSize{
    display: none;
    width: 12px;
    height: 12px;
    position: absolute;
...
.consume-detail .short{
    width: 400px;
}
.consume-detail .nopadding{
    padding: 0;
    margin: 0;
}
.consume-detail .nopadding .gray{
    padding: 0;
    margin: 0;
}
.consume-detail .input{
    width: 120px;
    height: 35px;
    line-height: 35px;
}
.consume-detail .input .el-input__inner{
    height: 35px;
    line-height: 35px;
}
.consume-detail .week-table .el-radio__label{
    display: block;
}
.consume-detail .week-table{
    border-collapse: collapse;
    margin-left: 94px;
    width:calc(100% - 94px);
}
.consume-detail .week-table td{
    border:1px solid rgb(194, 202, 216);
    padding: 4px 6px;
    height: 35px;
}
.consume-detail .bg-gray{
    background-color: #ececec;
}
.consume-detail .bglong{
    width:400px!important;
}
.consume-detail .bgvip{
    height: 43px!important;
}
.consume-detail .vip-check{
...
.consume-detail .discount-type{
    width:calc(100% - 84px);
}
.consume-detail .discount-type-wrapper{
    float: left;
    height: 35px;
    line-height: 35px;
}
.consume-detail .add-discount{
    color: #33CCCC;
    cursor: pointer;
}
.consume-detail .bgtable{
    /* width:calc(100% - 84px); */
    margin-right: 5px;
    margin-left: 94px;
    /* width: 100%; */
}
.consume-detail .table-wrapper{
    float: left;
    width: calc(100% - 84px);
    /* height: auto!important; */
}
.consume-detail .table-wrapper table{
...
.consume-detail .smallRangeDate .el-input__inner{
    height: 35px;
}
.consume-detail .el-radio-button, .el-radio-button__inner{
    margin-right:6px;
    border-radius:4px;  
}
.consume-detail .el-radio-button__inner{
    border:1px solid #dcdfe6;
}
.consume-detail .el-radio-button:first-child .el-radio-button__inner{
    border-radius:4px;
}
.consume-detail .el-radio-button:last-child .el-radio-button__inner{
    border-radius:4px;
}
.consume-detail .smallRangeDate .el-range-separator{
    height: 35px;
}
.consume-detail .bg-white{
...
.consume-detail .block{
    display: inline-block;
}
.consume-detail .bgradio{
    width: calc(100% - 84px);
}
.consume-detail .bgradio .el-input{
    display: inline-block;
    width: 80px;
    float: none;
}

.consume-detail .bgradio .radio-span{
    display: inline-block;
    height: 35px;
    line-height: 35px;
    font-size: 14px;
}
.consume-detail .bgradio .el-input__inner{
    height: 35px;
}

.consume-detail .bgradio .el-radio__label{
    display:inline-block;
}
.consume-detail .bgradio .el-input .el-input__inner{
    height: 32px;
}
.consume-detail .bgradio .el-radio{
    width:auto;
}
.consume-detail  .border-green{
...
.consume-detail .recharge-input{
    display: inline-block;
    width:80px;
}
.consume-detail .recharge-th{
    text-align:center;
}
.consume-detail .recharge-input .el-input__inner{
    width: 80px;
    height: 35px;
}
.consume-detail .td-1{
...
.consume-detail .table-input{
    width:157px;
    height:35px;
}
.consume-detail .table-input .el-input__inner{
    width:157px;
    height:35px;
}
.h35{
...
.consume-detail table .el-input__inner{
    border:1px solid #dcdfe6;
}
.add-common label{
    width:20%;
...
.consume-detail .showGoodsDialog{
    position: absolute;
    right: 20px;
    top: 10px;
}
