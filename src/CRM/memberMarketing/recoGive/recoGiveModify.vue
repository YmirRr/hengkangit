...
.reco-modify .bgradio .radio-span{
    display: inline-block;
    height: 35px;
    line-height: 35px;
    font-size: 14px;
}
.reco-modify .bgradio .el-input__inner{
    height: 35px;
}
.reco-modify .gray{
    font-size: 12px;
...
.reco-modify .showGoodsDialog{
    position: absolute;
    right: 20px;
}
.reco-modify .sizeNameBtn{
    display: block;
    width: 59px;
    height: 22px;
    text-align: center;
...
.reco-modify .sizeNameWrapper:hover .delSize{
    display: block;
}
.reco-modify .sizeNameWrapper .delSize{
    display: none;
    width: 12px;
    height: 12px;
    position: absolute;
...
.reco-modify .relative{
    position: relative;
}
</style>

<style>
.reco-modify .bgradio .el-radio__label{
    display:inline-block;
}
.reco-modify .bgradio .el-input .el-input__inner{
    height: 35px;
}
.reco-modify .bgradio .el-radio{
    width:auto;
}
.reco-modify .bgcolor .el-date-editor input{
    padding:0px;
}
.reco-modify .long{
    width: 445px;
}
.reco-modify .input-per .el-input{
