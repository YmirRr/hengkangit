    ...
    methods:{
        ...
        save(saveType){
            ...
            // self.$validate().then(function(success){
                ...
                // if(success){
                    self.$axios.posts('http://192.168.100.107:8092/api/services/app/ActivityManagement/UpdateMemberRechargeRule',self.createParams).then(function(res){
...
<style scoped>
.recharge-modify .erp_bt{
    height:24px;
}
.recharge-modify .erp_bt .btDetail{
    line-height:24px;
}
.recharge-modify .erp_bt .btImg img{
    top:-4px;
}
.recharge-modify .erp_bt{
    padding:0 6px;
...
.recharge-modify .sizeNameWrapper{
    margin-top: 5px;
    margin-bottom: 5px;
    display: block;
    width: 59px;
...
.recharge-modify .sizeNameWrapper:hover .delSize{
    display: block;
}
.recharge-modify .sizeNameWrapper .delSize{
    display: none;
    width: 12px;
    height: 12px;
    position: absolute;
...
.recharge-modify .long{
    width: 600px;
}
.recharge-modify .short{
    width: 400px;
}
.recharge-modify .nopadding{
    padding: 0;
    margin: 0;
}
.recharge-modify .nopadding .gray{
    padding: 0;
    margin: 0;
}
.recharge-modify .input{
    width: 120px;
    height: 35px;
    line-height: 35px;
}
.recharge-modify .input .el-input__inner{
    height: 35px;
    line-height: 35px;
}
.recharge-modify .week-table .el-radio__label{
    display: block;
}
.recharge-modify .week-table{
    border-collapse: collapse;
    margin-left: 94px;
    width:calc(100% - 94px);
}
.recharge-modify .week-table td{
    border:1px solid rgb(194, 202, 216);
    padding: 4px 6px;
    height: 35px;
}
.recharge-modify .bg-gray{
    background-color: #ececec;
}
.recharge-modify .bglong{
    width:400px!important;
}
.recharge-modify .bgvip{
    height: 43px!important;
}
.recharge-modify .vip-check{
...
.recharge-modify .discount-type{
    width:calc(100% - 84px);
}
.recharge-modify .discount-type-wrapper{
    float: left;
    height: 35px;
    line-height: 35px;
}
.recharge-modify .add-discount{
    color: #33CCCC;
    cursor: pointer;
}
.recharge-modify .bgtable{
    /* width:calc(100% - 84px); */
    margin-right: 5px;
    margin-left: 94px;
    /* width: 100%; */
}
.recharge-modify .table-wrapper{
    float: left;
    width: calc(100% - 84px);
    /* height: auto!important; */
}
.recharge-modify .table-wrapper table{
...
.recharge-modify .smallRangeDate .el-input__inner{
    height: 35px;
}
.recharge-modify .el-radio-button, .el-radio-button__inner{
    margin-right:6px;
    border-radius:4px;  
}
.recharge-modify .el-radio-button__inner{
    border:1px solid #dcdfe6;
}
.recharge-modify .el-radio-button:first-child .el-radio-button__inner{
    border-radius:4px;
}
.recharge-modify .el-radio-button:last-child .el-radio-button__inner{
    border-radius:4px;
}
.recharge-modify .smallRangeDate .el-range-separator{
    height: 35px;
}
.recharge-modify .bg-white{
...
.recharge-modify .none{
    display: none;
}
.recharge-modify .block{
    display: inline-block;
}
.recharge-modify .bgradio{
    width: calc(100% - 84px);
}
.recharge-modify .bgradio .el-input{
    display: inline-block;
    width: 80px;
    float: none;
}

.recharge-modify .bgradio .radio-span{
    display: inline-block;
    height: 35px;
    line-height: 35px;
    font-size: 14px;
}
.recharge-modify .bgradio .el-input__inner{
    height: 35px;
}

.recharge-modify .bgradio .el-radio__label{
    display:inline-block;
}
.recharge-modify .bgradio .el-input .el-input__inner{
    height: 32px;
}
.recharge-modify .bgradio .el-radio{
    width:auto;
}
.recharge-modify  .border-green{
...
.recharge-modify .recharge-input{
    display: inline-block;
    width:80px;
}
.recharge-modify .recharge-th{
    text-align:center;
}
.recharge-modify .recharge-input .el-input__inner{
    width: 80px;
    height: 35px;
}
.recharge-modify .td-1{
    width:10%;
    vertical-align:middle;
}
.recharge-modify .td-2{
    width:20%;
    vertical-align:middle;
}
.recharge-modify .td-3{
    width:55%;
}
.recharge-modify .td-4{
    width:15%;
    vertical-align:middle;
}
.tc{
...
.recharge-modify .table-input{
    width:157px;
    height:35px;
}
.recharge-modify .table-input .el-input__inner{
    width:157px;
    height:35px;
}
.h35{
...
.recharge-modify table .el-input__inner{
    border:1px solid #dcdfe6;
}
.add-common label{
    width:20%;
...
.recharge-modify .showGoodsDialog{
    position: absolute;
    right: 20px;
    top: 10px;
}
