...
<template>
    <div class="recharge-give commodity">
...
export default {
    ...
    data(){
        return{
            ...
            tableModel:'rechargeGiveList',
            httpUrl:{
                view:'/rechargeGive/rechargeGiveModify/',
            ...
            queryParams:{
                ActivityTypeid:4,//活动类型
                ActivityNo:'',//活动编码
                ActivityName:'',//活动名称
                Status:'',//状态
                EffectiveStart:'',
                EffectiveEnd:'',
                SkipCount:(this.$store.state.rechargeGiveListCurrentPage-1)*this.$store.state.rechargeGiveListEachPage,
                MaxResultCount:this.$store.state.rechargeGiveListEachPage
            },
            command:[{
                text:'查看',
                class:'blue'
    ...
    methods:{
        ...
        goDetail(){//点击新增跳转
            this.$store.state.url='/rechargeGive/rechargeGiveDetail/default'
...
.recharge-give .leftBox{
    width: 290px;
}
.recharge-give .rightBox{
    width: calc(100% - 290px);
    min-height: 339px;
    /* border-left: 1px solid #E4E4E4; */
}
.recharge-give .newRight{
    width: 100%;
}
.recharge-give .smallRangeDate{
    height: 35px;
}
.recharge-give .smallRangeDate .el-input__inner{
    height: 35px;
}
.recharge-give .rangeDate{
    width: 181.25px;
}
.recharge-give .f14{
    font-size: 14px;
}
.recharge-give .border-left{
    border-left: 1px solid #E4E4E4;
}
</style>
<style>
.recharge-give .smallRangeDate .el-range-separator{
    line-height: 35px;
}
</style>