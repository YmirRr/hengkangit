<template>
    <div class="integral-birth">
            ...
            <el-col class="mt10 mb10">
                ...
                <el-row>
                    ...
                    <el-col class="rangeDate smallRangeDate" :span="15">                        
                        <el-date-picker  v-model="chooseDate" :class="{redBorder : validation.hasError('chooseDate')}" @focus="showErrprTips" @change="Modify"
                        type="daterange"
                        range-separator="至">
                        </el-date-picker>
                    </el-col> 
                ...
                <el-row>
                    <div class="bgcolor bgradio">
                        ...
                        <el-radio v-model="range" label="1" @change="Modify">生日当天</el-radio>
                        <el-radio v-model="range" label="2" @change="Modify">生日当周</el-radio>
                        <el-radio v-model="range" label="3" @change="Modify">生日当月</el-radio>
                    </div>
                </el-row>
                <el-row>
                    <div class="bgcolor">
        ...
        <!-- 渠道弹框 -->
        <el-dialog :visible.sync="qudialog"  class="transfer_dialog dialogOu" width="50%">
            <span slot="title">
                <span>选取渠道</span>
                <div class="search_input_group">
                    <div class="search_input_wapper">
...
export default {
    ...
    methods:{
        ...
        goModify:function(id){//点击跳转修改页modify
            this.$store.state.url='/integralFactor/integralBirthModify/'+id;
            this.$router.push({path:this.$store.state.url})//点击切换路由
        },
        //---树通用----------------------------------------------
...
.integral-birth .transfer_warapper{
    border:none;
}
.integral-birth .bgrow{
    margin-bottom: 0;
}
/* .integral-birth .mul-input .el-input{
    height: 35px;
    line-height:35px;
    width:80px;
} */
