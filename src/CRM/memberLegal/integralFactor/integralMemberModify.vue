            ...
            <el-col class="mt10 mb10">
                ...
                <el-row class="bt1">
                    <div class="bgcolor bgradio bgrow">
                        ...
                        <el-radio v-model="allData.applyTypeid" label="1" @change="changeRange">按业务组织</el-radio>
                        <el-radio v-model="allData.applyTypeid" label="2" @change="changeRange">按业务地区</el-radio>
                        <el-radio v-model="allData.applyTypeid" label="3" @change="changeRange">按渠道</el-radio>
                    </div>
                </el-row>
...
export default {
    ...
    validators: {
        ...
        'allData.tacticCode': function (value) {//名称
            return this.Validator.value(value).required();
        },
                ...
                if(success){
                    ...
                    _this.$axios.posts(config.base.ip+':'+config.base.crmPort+'/api/services/app/CrmIntegralTacticManagement/AggregateCreateOrUpdate',_this.addData).then(function(res){
                        ...
                        if(saveType=="save"){
                            ...
                            _this.$store.state.url='/integralFactor/integralFactorMember/default'
