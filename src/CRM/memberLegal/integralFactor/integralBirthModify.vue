            ...
            <el-col class="mt10 mb10">
                <el-row>
                    <div class="bgcolor">
                        ...
                        <el-input placeholder="" @focus="showErrprTips" v-model="allData.tacticCode" :class="{redBorder : validation.hasError('allData.tacticCode')}"></el-input>
                    </div>
                </el-row>
                <el-row>
                    <div class="bgcolor">
                        <label><small>*</small>名称</label>
                        <el-input placeholder="" @focus="showErrprTips" v-model="allData.tacticName" :class="{redBorder : validation.hasError('allData.tacticName')}"></el-input>
                    </div>
                </el-row>
                <el-row>
                    <div class="bgcolor short">
                    <label><small>*</small>生效时间</label>
     
                    <el-col class="rangeDate smallRangeDate" :span="15">                        
                        <el-date-picker  v-model="chooseDate" :class="{redBorder : validation.hasError('chooseDate')}" @focus="showErrprTips"
                        type="daterange"
                        range-separator="至"
                ...
                <el-row>
                    <div class="bgcolor bgradio">
                        <label><small>*</small>生效范围</label>
                        <el-radio v-model="range" label="1">生日当天</el-radio>
                        <el-radio v-model="range" label="2">生日当周</el-radio>
                        <el-radio v-model="range" label="3">生日当月</el-radio>
                    </div>
                </el-row>
                <el-row>
                    <div class="bgcolor">
                ...
                if(success){
                    _this.$axios.posts(config.base.ip+':'+config.base.crmPort+'/api/services/app/CrmIntegralTacticManagement/AggregateCreateOrUpdate',_this.addData).then(function(res){
                        ...
                        if(saveType=="save"){
                            ...
                            _this.$store.state.url='/integralFactor/integralFactorBirth/default'
