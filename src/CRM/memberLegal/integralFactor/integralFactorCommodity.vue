            ...
            <el-col class="mt10 mb10">
                <el-row>
                    <div class="bgcolor">
                        ...
                        <el-input placeholder="" v-model="addData.integralTactic_MainTable.tacticCode" @change="Modify" @focus="showErrprTips" :class="{redBorder : validation.hasError('addData.integralTactic_MainTable.tacticCode')}"></el-input>
                    </div>
                </el-row>
                <el-row>
                    <div class="bgcolor">
                        <label><small>*</small>名称</label>
                        <el-input placeholder="" v-model="addData.integralTactic_MainTable.tacticName" @change="Modify" @focus="showErrprTips" :class="{redBorder : validation.hasError('addData.integralTactic_MainTable.tacticName')}"></el-input>
                    </div>
                </el-row>
                <el-row>
                    ...
                    <el-col class="rangeDate smallRangeDate" :span="15">                        
                        ...
                        type="daterange" @change="Modify" @focus="showErrprTips"
                        range-separator="至">
                        </el-date-picker>
                    </el-col> 
                    </div>
                ...
                <el-row>     
                    <table class="week-table">
                        <tr>
                            ...
                            <td>
                                <el-input placeholder="请输入月日" class="input" v-model="addData.freq_ChildTable.selectYear" :disabled="radio!='1'"></el-input>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-input placeholder="请输入日" class="input" v-model="addData.freq_ChildTable.selectMonth" :disabled="radio!='2'"></el-input>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-radio-group v-model="addData.freq_ChildTable.selectWeek" :disabled="radio!='3'">
                        ...
                        <tr>
                            <td class="bg-gray"><el-radio v-model="radio" label="4" :disabled="!checked" @change="Modify">生日</el-radio></td>
                            <td>
                                <el-radio v-model="addData.integralTactic_MainTable.tacticTypeid" label="1" :disabled="radio!='4'">生日当天</el-radio>
                                <el-radio v-model="addData.integralTactic_MainTable.tacticTypeid" label="2" :disabled="radio!='4'">生日当周</el-radio>
                                <el-radio v-model="addData.integralTactic_MainTable.tacticTypeid" label="3" :disabled="radio!='4'">生日当月</el-radio>
                            </td>
                        </tr>
                    </table>
                </el-row>
                ...
                <el-row class="bt1">
                    <div class="bgcolor bgradio bgrow">
                        ...
                        <el-radio v-model="addData.integralTactic_MainTable.applyTypeid" label="1" @change="Modify">按业务组织</el-radio>
                        <el-radio v-model="addData.integralTactic_MainTable.applyTypeid" label="2" @change="Modify">按业务地区</el-radio>
                        <el-radio v-model="addData.integralTactic_MainTable.applyTypeid" label="3" @change="Modify">按渠道</el-radio>
                    </div>
                </el-row>
                <el-row>
            ...
            _this.$validate().then(function(success){
                ...
                if(_this.addData.integralTactic_MainTable.applyTypeid=="1"){
                    ...
                    if(_this.radio=="1"){
                        ...
                        _this.addData.freq_ChildTable[0].perBirthday=true; 
                        if(_this.range=="1"){
                            _this.addData.freq_ChildTable[0].selectBirthDay=true; 
                        }else if(_this.range=="2"){
                            _this.addData.freq_ChildTable[0].selectBirthWeek=true; 
                        }else if(_this.range=="3"){
                            _this.addData.freq_ChildTable[0].selectBirthMonth=true; 
                        }
                    }
