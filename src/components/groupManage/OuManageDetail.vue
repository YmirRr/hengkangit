        ...
        <el-row>
            ...
            <!-- - - - - - - - - - - - - - - - -业务 - - - - - - - - - - - - -->
                ...
                <div class="bgcolor">
                    ...
                    v-model="addData.baseCurrrencyId">
                        <el-option 
                        v-for="item in baseCurrency" 
                        :key="item.id" 
        ...
        <el-dialog :visible.sync="errorMessage" class="dialog_confirm_message" width="25%">
            ...
            <el-col :span="24" style="position: relative;">
                <el-col :span="24">
                    ...
                    <p class="dialog_font dialog_body_message">信息填报有误！</p>
                </el-col>
                <el-collapse-transition>
...
//------------------------财务--------------------------
    ...
    computed:{
        ...
        baseCurrency: function () {//下拉数据自定义搜索过滤
            return FILTER_MOTHED(this.filterKey,this.selectData.baseCurrencyId)
            },  
    },
    // mounted() {
    //         this.loadList();
     ...
     seletChange(val){
        ...
        loadTree(){
            ...
            .then(function(res){
                ...
                _this.expand_Ou=_this.defauleExpandTree(res,'id')
            },function(res){
            })
        },
        loadTreeCompany(){
...
.ou-detail .inline-block-need{
    display: inline-block;
}
.ou-detail .bgcolor.longWidth{
    width: 505px;
    height:auto;
 }
 .bb1{
...
.ou-detail .bgcolor.longWidth .el-textarea{
    width: calc(100% - 94px);
    font-size: 12px;
 } 
/*表单提示信息*/
...
.ou-detail .el-row:first-child{
    border-bottom:none;
}
.ou-detail .el-row:last-child{
      border-bottom:none;
  }
 .ou-detail .getPadding,.tabZoo .el-tabs__nav-scroll{
     padding: 0 10px;
 }
 .ou-detail .tabZoo .el-tabs__active-bar{
...
.ou-detail .nopadding{
  ...
  <style>
  .ou-detail .bgcolor .el-select .el-input input{
