<template>
    <div class="customer-infor-wrapper commodity">
            <el-col class="leftBox" v-show="ifWidth">
                ...
                <el-row class="mt10">
                    <el-col :span="8">
                         <label class="input-label">客户分类</label>
                    </el-col>
                    <el-col :span="15">
                ...
                <el-row class="mt10">
                    <el-col :span="8">
                        <label class="input-label">客户性质</label>
                    </el-col>
                    <el-col :span="15">
    ...
    export default{
        ...
        data(){
            return {
                ...
                httpUrl:{
                    view:'/customer/customerModify/',
                    delete:'/api/services/app/ContactManagement/Delete',//行内删除
                    query:'/api/services/app/ContactManagement/GetListByConditionCustomer',//条件查询
                },
                tableModel:'customerList',
                tableData:[],
                SelectionChange:[],
                column: [{
                    prop: 'ouId_OuName',
                    ...
                    queryParams:{
                        ...
                        ContactCode:'',//编码
                        ContactName:'',//名称
                        SkipCount:(this.$store.state.customerListCurrentPage-1)*this.$store.state.customerListEachPage,
                        MaxResultCount:this.$store.state.customerListEachPage
                    }, 
            }
        },
        created:function(){
        ...
        doSearch:function(){
            ...
            self.$axios.gets('/api/services/app/ContactManagement/GetListByConditionCustomer',self.queryParams).then(function(res){
                console.log(res)
        ...
        dialogClick(parmas){
            if(parmas.dialogButton=="确定"){
                if(parmas.dialogName=="delDialog"){//删除对话框
                    ...
                    if(_this.idArray.ids.length>0){
                        _this.$axios.posts('/api/services/app/ContactManagement/BatchDelete',_this.idArray).then(function(res){
...
.customer-infor-wrapper .leftBox{
    min-width: 290px;
    width: 290px;
}
.input-need{
...
.customer-infor-wrapper .rightBox{
    width: calc(100% - 290px)
}
.customer-infor-wrapper .newRight{
    width: 100%;
}
.h48{
    height: 48px;
...
.customer-infor-wrapper .inline-block-need{
    display: inline-block;
}
.open-search{
